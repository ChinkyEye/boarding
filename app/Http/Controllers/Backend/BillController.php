...
class BillController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.accountsection.bill.index',compact('shifts'));
    }
    ...
    public function main($slug)
    {
      ...
      return view('backend.accountsection.bill.create',compact('student_id','topics','user_info','student_info','shift','class','section'));
    }
    ...
    public function create()
    {
        $topics = Topic::get();
        // dd($topics);
        return view('backend.accountsection.bill.create',compact('topics'));
    }
    ...
    public function getStudentBillList(Request $request){
      ...
      return view('backend.accountsection.bill.student_ajax', compact('datas','shifts','classes','sections'));
    }
    ...
    public function getBillCalculateList(Request $request)
    {
       ...
       $total_fee = 0;
        ...
        return view('backend.accountsection.bill.bill_calculation',compact('total_fee'));    
    }
    ...
    public function getBillFeeList(Request $request)
    {
        ...
        return view('backend.accountsection.bill.bill_row',compact('item_id','fee','topic'));    
    }
    ...
    public function store(Request $request)
    {
        ...
        // dd($request,$billtotal);
         return redirect()->route('admin.bill.print',['bill_id' => $calc_bill_id]);
    }
    ...
    public function print($bill_id){
      ...
      return view('backend.accountsection.bill.print',compact('settings','student_id','bill_id','bill_total_student','bill_published','datas'));
    }
