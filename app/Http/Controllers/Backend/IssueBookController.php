...
class IssueBookController extends Controller
{
    ...
    public function index()
    {
        ...
        $issuebooks = IssueBook::where('school_id', Auth::user()->school_id)->where('batch_id', Auth::user()->batch_id)
                                ...
                                ->orderBy('id','DESC')
                                ->get();
        return view('backend.librarysection.issuebook.index', compact('shifts','issuebooks'));
    }
    ...
    public function create()
    {
        $shifts = Shift::where('school_id', Auth::user()->school_id)->where('batch_id', Auth::user()->batch_id)
                        ->where('is_active','1')
                        ->get();
        return view('backend.librarysection.issuebook.create', compact('shifts'));
    }
    ...
    public function store(Request $request)
    {
      ...
      // dd($bookQuantity,$selectBookCount);
        ...
        return redirect()->route('admin.issuebook.index')->with($pass);
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.librarysection.issuebook.show', compact('issuebooks'));
    }
    ...
    public function edit($id)
    {
      ...
      return view('backend.librarysection.issuebook.edit', compact('issuebooks','students','books'));
    }
    ...
    public function update(Request $request, IssueBook $issuebook)
    {
        ...
        return redirect()->route('admin.issuebook.index')->with($notification);
    }
    ...
    public function getIssuebookRecord(Request $request){
        ...
        return view('backend.librarysection.issuebook.index-ajax', compact('issuebooks_count','issuebooks','date'));
    }
    ...
    public function getStudentIssueList(Request $request){
      $issuebooks = IssueBook::where('school_id', Auth::user()->school_id)->where('batch_id', Auth::user()->batch_id)
                            ...
                            ->get();
      $issuebooks_count = count($issuebooks);
        return view('backend.librarysection.issuebook.create-ajax', compact('issuebooks_count','issuebooks'));
    }
}
