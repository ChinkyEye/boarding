...
class LedgerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.examsection.ledger.index',compact('shifts','exams'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $classmarks_group = Markclass::where('school_id',Auth::user()->school_id)
                                    ...
                                    ->groupBy('subject_id')
                                    ->get();
        $classmarks = Markclass::where('school_id',Auth::user()->school_id)
                                ->where('classexam_id',$classexam_id)
                                ->orderBy('subject_id','ASC')
                                ->get(); 
        // dd($classmarks);
        ...
        return view('backend.examsection.ledger.create', compact('shifts','exams','datas','shifts_name','sections_name','classes_name','exams_name','exam','subjects','classmarks','classmarks_group','studentmarks','classexam_id','exam_id','class_id','request'));
    }
    ...
    public function ledgerView()
    {
        $shifts = Shift::where('school_id',Auth::user()->school_id)->get();
        $exams = Exam::where('school_id',Auth::user()->school_id)->get();
        return view('backend.examsection.ledger.view',compact('shifts','exams'));
    }
...
// dd($sections_name);
        ...
        return view('backend.examsection.ledger.show', compact('shifts','exams','datas','shifts_name','classes_name','sections_name','exams_name','exam','subjects','classmarks','studentmarks','classexam_id','exam_id','class_id','grades','request'));
    }
    ...
    public function getMarkPrint($slug,$exam)
    {
      ...
      return view('backend.examsection.ledger.getmarkprint',compact('subjects','slug','exam','user_id'));
    }
    ...
    public function getGradePrint($slug,$exam)
    {
      ...
      return view('backend.examsection.ledger.getgradeprint',compact('subjects','slug','exam','user_id'));
    }
    ...
    public function getBothPrint($slug,$exam)
    {
      ...
      return view('backend.examsection.ledger.getbothprint',compact('subjects','slug','exam','user_id'));
    }
