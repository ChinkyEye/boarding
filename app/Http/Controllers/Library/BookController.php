...
class BookController extends Controller
{
   ...
   public function getAllBook(Request $request)
   {
       ...
       if(!empty($posts))
       {
           foreach ($posts as $index=>$post)
           {
               ...
               <a href='".route('library.book.show',$post->id)."' class='btn btn-xs btn-outline-success' data-toggle='tooltip' data-placement='top' title='View Detail'><i class='fa fa-eye'></i></a>
               <a href='".route('library.book.edit',$post->id)."' class='btn btn-xs btn-outline-info' data-toggle='tooltip' data-placement='top'title='Update'><i class='fas fa-edit'></i></a> 

               <form action='javascript:void(0)' data_url'".route('library.book.destroy',$post->id)."' method='post' class='d-inline-block delete-confirm' data-toggle='tooltip' data-placement='top' title='Permanent Delete' onclick='myFunction(this)'>
   ...
   public function create()
   {
       ...
       return view('library.book.create', compact('classes'));
   }
   ...
   public function store(Request $request)
   {
       ...
       return redirect()->route('library.book.index')->with($pass);
   }
   ...
   public function show($id)
   {
       ...
       return view('library.book.show', compact('books'));
   }
   ...
   public function edit($id)
   {
       ...
       // $books = Book::where('school_id', Auth::user()->school_id)->where('batch_id', Auth::user()->batch_id)->where('id', $id)->get();
       // return view('library.book.edit', compact('books','classes','subjects'));
       ...
       $subjects = Subject::where('school_id', Auth::user()->school_id)->where('batch_id', Auth::user()->batch_id)
                           ...
                           ->get();
       return view('library.book.edit', compact('books','subjects'));
   }
   ...
   public function update(Request $request, Book $book)
   {
       ...
       return redirect()->route('library.book.index')->with($notification);
