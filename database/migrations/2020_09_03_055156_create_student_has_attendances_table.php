...
class CreateStudentHasAttendancesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_has_attendances', function (Blueprint $table) {
            ...
            $table->boolean('status')->default(1); //1 vaneko present o vaneko absent
    ...
    {
        Schema::dropIfExists('student_has_attendances');
    }
}
