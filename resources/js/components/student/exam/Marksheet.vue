              ...
              <div class="card-header">
                <div class="row">
                 <div class="float-right">
                  <button type="button" class="btn btn-xs btn-info rounded-0" @click="print">Print me</button>
                 </div>
                </div>
              </div>
            
              <div class="card-body" v-if="studentlists == 0">
                ...
                <div id="printMe">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover table-sm">
                      ...
                      <tbody v-for="(exam, index) in studentlists" :key="exam.id">
...
<script>
  export default {
    ...
    created(){
      axios.get(`/student/exam/${this.$route.params.examid}`)
      .then((response)=>{
        this.studentlists = response.data.studentlists;
        this.allgrade = response.data.gradelist; // grade
        this.allobservation = response.data.studentlists.[0].get_student_observation_published_one; // StudentHasObservation
        this.allobservation_mark = response.data.studentlists.[0].get_student_observation_published_one.get_student_observation_mark; // 
        this.schoolinfo = response.data.studentlists.[0].get_school;
        this.student = response.data.studentlists.[0].get_student_one; // student
        this.userstudent = response.data.studentlists.[0].get_student_user;
        this.terminal_info = response.data.studentlists.[0].get_class_exam.[0]; // exam_has_class
        this.terminal_name = response.data.studentlists.[0].get_class_exam.[0].get_exam; // exam
        this.sbatch = response.data.studentlists.[0].get_student_one.get_batch; // batch
        this.sshift = response.data.studentlists.[0].get_student_one.get_shift; // shift
        this.sclass = response.data.studentlists.[0].get_student_one.get_class; // class
        this.ssection = response.data.studentlists.[0].get_student_one.get_section; // section
