...
<tr>
   ...
   <td class="text-center">
    <a href="{{ route('account.laganikosh',$teacherincome->id) }}" class="btn btn-xs btn-outline-success" data-toggle="tooltip" target='_blank' data-placement="top" title="नागरिक लगानी कोष"><i class="fas fa-plus"></i></a>
    <a href="{{ route('account.pfledger',$teacherincome->id) }}" class="btn btn-xs btn-outline-info" data-toggle="tooltip" data-placement="top" target='_blank' title="pfledger"><i class="fas fa-print"></i></a>
    <a href="{{ route('account.talabmaagfarum',$teacherincome->id) }}" class="btn btn-xs btn-outline-success" data-toggle="tooltip" target='_blank' data-placement="top" title="शिक्षक तलब माग फाराम"><i class="fas fa-file"></i></a>
    <a href="{{ route('account.gosawaravoucher',$teacherincome->id) }}" class="btn btn-xs btn-outline-info" data-toggle="tooltip" target='_blank' data-placement="top" title="गोश्रारा भौचर"><i class="fas fa-file-invoice"></i></a>
    <a href="{{ route('account.gosawaravoucherkharcha',$teacherincome->id) }}" class="btn btn-xs btn-outline-info" data-toggle="tooltip" target='_blank' data-placement="top" title="गोश्रारा भौचर - खर्च"><i class="fas fa-file-alt"></i></a>
