...
<section class="content">
  <div class="card">
    <div class="card-header">
      <a href="{{ route('account.topic.create')}}" class="btn btn-sm btn-info text-capitalize" data-toggle="tooltip" data-placement="top" title="Add Topic">Add {{ $page }} </a>
...
<script type="text/javascript">
  $('#topic').DataTable({
    ...
    "serverSide": true,
    "ajax":{
      "url": "{{route('account.getAllAccountTopic')}}",
      "dataType": "json",
      "type": "POST",
      "data":{ 
