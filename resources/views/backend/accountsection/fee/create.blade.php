    ...
    <div class="row">
      <div class="col-md">
        <div class="card card-info">
          <form role="form" method="POST" action="{{route('admin.fee.store')}}" class="validate" id="validate">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr style="background-color: {{$bills->bill_type == '2' ? '#cde0ba' : '#eccdcd'}}">
                    <th style="width:50%"><a href="{{route('admin.bill.print',['bill_id' => $bills->invoice_id])}}" target="_blank">{{ $bills->invoice_id }}</a></th>
