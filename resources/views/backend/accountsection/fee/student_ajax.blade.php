	...
	<table class="table table-bordered table-hover position-relative m-0">
		...
		<tr class="text-center">
			...
			<td class="text-center">
				<a target="_blank" href="{{ route('admin.fee.student',[$data->slug]) }}" class="btn btn-xs btn-outline-info" data-toggle="tooltip" data-placement="top" title="Show Detail"><i class="fas fa-plus"></i></a>
				<a target="_blank" href="{{ route('admin.fee.viewstudentfee',[$data->slug]) }}" class="btn btn-xs btn-outline-info" data-toggle="tooltip" data-placement="top" title="Show Detail"><i class="fas fa-eye"></i></a>
			</td>
		</tr>
		@endforeach
	</table>
