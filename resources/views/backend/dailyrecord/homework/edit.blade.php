...
<section class="content">
  <div class="card card-info">
    <form role="form" method="POST" action="{{route('admin.homework.update',$homeworks->id)}}" class="signup" id="signup">
      <div class="card-body">
        @method('PATCH')
        @csrf
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <span> : {{$homeworks->getTeacherName->name}} {{$homeworks->getTeacherName->middle_name}} {{$homeworks->getTeacherName->last_name}}</span>
          </div>
          <div class="form-group col-md-3">
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        $.each( response, function( i, val ) {
          $('#teacher_id').append('<option value='+val.teacher.id+'>'+val.teacher.name+'</option>');
        });
      },
