...
<section class="content">
  <div class="card">
    <div class="card-header">
      <a href="{{ route('admin.routine.create')}}" class="btn btn-sm btn-info text-capitalize">Add {{ $page }} </a>
    ...
    <div class="card-header">
      <div class="row">
        <div class="col-md">
          <select class="form-control shift_data" name="shift_id" id="shift_data">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr class="text-center {{$element->is_active == '1' ? '' : 'bg-light-danger'}}">
              ...
              <td>
                <a class="d-block text-center" href="{{route('admin.routine.active',$element->id)}}" data-toggle="tooltip" data-placement="top" title="{{$element->is_active == '1' ? 'Click to deactivate' : 'Click to activate'}}">
              ...
              <td>
                ...
                <form action="{{route('admin.routine.destroy',$element->id)}}" method="post" class="d-inline-block delete-confirm" data-toggle="tooltip" data-placement="top" title="Permanent Delete">
                  @csrf
                  @method('DELETE')
...
<script type="text/javascript">
  $("body").on("click", "#routineSearch", function(event){
      ...
      $.ajax({
        type:"POST",
        dataType:"html",
        url: "{{URL::route('admin.getRoutineRecord')}}",
        data: {
          _token: token,
