...
<section class="content">
  <div class="card card-info">
    ...
    <form role="form" method="POST" action="{{ route('admin.notice.update',$notice->id)}}" class="validate" id="validate">
      <div class="card-body">
        @method('PATCH')
        @csrf
        <div class="row">
          <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="title" name="title" autocomplete="off" value="{{$notice->title}}">
            @error('title')
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="start_date_np" name="start_date_np" autocomplete="off" value="{{$notice->start_date_np}}">
            @error('start_date_np')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="end_date_np" name="end_date_np" autocomplete="off" value="{{ $notice->end_date_np }}">
            @error('end_date_np')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
      ...
      <div id="replaceButtom"></div>
      <div class="card-footer justify-content-between">
        <button type="submit" class="btn btn-info text-capitalize">Update</button><br>
      </div>
    </form>
    @endforeach
  </div>
