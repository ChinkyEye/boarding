  ...
  <div class="card">
    ...
    <form role="form" method="POST" action="{{ route('admin.teacher.update',$teacher->id)}}" enctype="multipart/form-data">
      ...
      <div class="modal-body" >
        <div class="row">
          ...
          <div class="form-group col-sm-4">
            ...
            <input type="text"  class="form-control max" id="f_name" placeholder="Enter First Name" name="f_name"  autocomplete="off" value="{{ $teacher->getTeacherUser->name }}">
            @error('f_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-4">
            ...
            <input type="text"  class="form-control max" id="m_name" placeholder="Enter Middle Name" name="m_name"  autocomplete="off" value="{{ $teacher->getTeacherUser->middle_name }}">
            @error('m_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-4">
            ...
            <input type="text"  class="form-control max" id="l_name" placeholder="Enter Last Name" name="l_name" autocomplete="off" value="{{ $teacher->getTeacherUser->last_name }}">
            @error('l_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <fieldset class="border border-info container-fluid col-md-12 p-2 mb-2">
            ...
            <div class="row">
              <div class="form-group col-sm-12">
                ...
                <input type="text"  class="form-control max" id="email" placeholder="Enter email" name="email" autocomplete="off" value="{{ $teacher->getTeacherUser->email}}" disabled>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <img src="{{URL::to('/')}}/images/teacher/{{$teacher->slug}}/{{$teacher->image}}" id="profile-img-tag" width="200px" onclick="document.getElementById('image').click();" alt="your image" class="img-thumbnail img-fluid editback-gallery-img center-block"  />
            </div>
            @error('image')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
      ...
      <div class="modal-footer justify-content-between">
        <button type="submit" class="btn btn-info text-capitalize">Update Teacher</button>
      </div>
    </form>
    @endforeach
  </div>
