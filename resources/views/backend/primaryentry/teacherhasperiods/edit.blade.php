      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group col-sm-4">
            ...
            {{-- <input type="text" name="class_id" value="7"> --}}
            <select class="form-control" name="class_id" id="filter_class">
              ...
              <option value="{{$class_shift->class_id}}" {{ $class_shift->class_id == $teacherhasperiod->class_id ? 'selected' : ''}}>{{$class_shift->getClass->name}}</option>
              @endforeach
              @endforeach
            </select>
            @error('class_id')
