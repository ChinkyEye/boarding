...
<html>
  <head>
    ...
    <title>Student Attendance Detail Download</title>
  ...
  <body>
    <div class="table-responsive">
      <div>
        ...
        <h1>Month : Chaitra </h1>
        @endif
        <p>Student Name : {{$student_info->getStudentUser->name}} {{$student_info->getStudentUser->middle_name}} {{$student_info->getStudentUser->last_name}}</p>
