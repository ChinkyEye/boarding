    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{route('admin.student.index')}}"> Teacher</a></li>
        ...
        <div class="row">
          <div class="col-md p-0">
            ...
            <div class="tab-content p-3" id="nav-tabContent">
              ...
              <form role="form" class="row mb-3" method="GET" action="{{ route('main.school.student.report.attendance.month.search',[$school_info->slug])}}">
              ...
              <div id="printTable">
                <div class="table-responsive">
                  <div>
                    ...
                    <h1>Month : Chaitra </h1>
                    @endif
                    <p>{{$student_info->getStudentUser->name}} {{$student_info->getStudentUser->middle_name}} {{$student_info->getStudentUser->last_name}}/({{$student_info->student_code}})</p>
                  </div>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      @forelse ($main[$i] as $attendance)
                        ...
                        <td>
                          {{$attendance->getUser->name}} {{$attendance->getUser->middle_name}} {{$attendance->getUser->last_name}}
                        </td>
                      @empty
                        <td>-</td>
                        <td>-</td>
