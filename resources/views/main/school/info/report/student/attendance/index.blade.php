    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{route('admin.teacher.index')}}"> Student</a></li>
        ...
        <div class="row">
          <div class="col-md p-0">
            ...
            <div class="tab-content p-3" id="nav-tabContent">
              ...
              <form role="form" class="row mb-3" method="GET" action="{{ route('main.school.student.report.attendance.search',[$school_info->slug])}}">
                <div class="col-md">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tr class="text-center" keys="{{$key}}">
                      ...
                      <td>{{$attendance->getStudentUser->name}} {{$attendance->getStudentUser->middle_name}} {{$attendance->getStudentUser->last_name}} ({{$attendance->student_code}} )</td>
                       ...
                       @endif
                       <td>
                        <form action="{{ route('main.school.student.report.attendance.detail',[$school_info->slug,$attendance->user_id]) }}" method="GET" class="d-inline-block">
