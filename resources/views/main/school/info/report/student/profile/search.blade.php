      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md p-0">
            @include('main.school.info.report.student.nav')
            
            <div class="tab-content p-3" id="nav-tabContent">
              <form role="form" class="row mb-3" method="GET" action="{{ route('main.school.student.report.profile.search',[$school_info->slug])}}">
                {{-- <div class="col-md">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover">
                    ...
                    <tr class="text-center">
                      ...
                      <td class="text-left">
                        {{$student->student_has_parent_count?$student->Student_has_parent->father_name:''}}
                      </td>
                      <td class="text-left">
                        {{$student->student_has_parent_count?$student->Student_has_parent->mother_name:''}}
                      </td>
                      <td class="text-left">{{$student->phone_no}}</td>
                      <td class="text-left">
                        {{$student->student_has_parent_count?$student->Student_has_parent->address:''}}
                      </td>
                      <td class="text-left">{{$student->getUser->name}} {{$student->getUser->middle_name}} {{$student->getUser->last_name}}</td>
                      <td>
                        <a href="{{ route('main.student.show',[$school_info->slug,$student->slug]) }}" class="btn btn-xs btn-outline-info" data-toggle="tooltip" data-placement="top" title="View Detail" target="_blank"><i class="fas fa-eye"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </table>
