      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="form-group col-md-4">
            ...
            <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Enter Your Name" autocomplete="off" value="{{$student->first_name}}">
            @error('first_name')
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" name="middle_name" class="form-control" id="middle_name" placeholder="Enter Your Name" maxlength="15" autocomplete="off" value="{{$student->middle_name}}">
          </div>
          <div class="form-group col-md-4">
            <label for="address">Last name</label>
            <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Enter Your Name" maxlength="15" autocomplete="off" value="{{$student->last_name}}">
            @error('last_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-md-63">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="email" name="email" class="form-control" id="email" autocomplete="off" value="{{$student->email}}">
            @error('email')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text"  class="form-control" id="father_name" name="father_name"  autocomplete="off" value="{{$student->Student_has_parent->father_name}}">
            @error('father_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text"  class="form-control" id="mother_name"  name="mother_name"  autocomplete="off" value="{{$student->Student_has_parent->mother_name}}">
            @error('mother_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text"  class="form-control" id="address" name="address"   autocomplete="off" value="{{$student->Student_has_parent->address}}"> 
            @error('address')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-md-6">
            ...
            <select class="form-control" name="nationality_id">
              ...
              <option value="{{ $nationality->id }}"  @foreach($students as $student) {{$student->Student_has_parent->nationality_id == $nationality->id ? 'selected' : ''}} @endforeach> 
                {{$nationality->n_name}}
              </option>
              @endforeach    
            </select>
