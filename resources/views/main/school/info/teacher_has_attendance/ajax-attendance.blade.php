	  	...
	  	{{-- today attendance --}}
	  		...
	  		{{-- {{dd($check_count,$datas)}} --}}
	  			...
	  			<tr class="text-center {{$data ? ($data->status == 1 ? '' : 'bg-light-danger') : 'bg-light-warning'}}">
	  				<td>{{$data->getTeacherInfoOne->teacher_code}}</td>
	  				<td>
	  				...
	  				<td class="text-left">{{$data->getTeacherName->name}} {{$data->getTeacherName->middle_name}} {{$data->getTeacherName->last_name}}</td>
	  				<td>
	  		...
	  		{{-- teacher --}}
	  			...
	  			<tr class="text-center">
	  				<td>{{$data->getTeacherInfo->teacher_code}}</td>
	  				<td>
	  					<div class="form-check form-check-inline">
	  				...
	  				<td class="text-left">{{$data->getTeacherInfo->getTeacherUser->name}} {{$data->getTeacherInfo->getTeacherUser->middle_name}} {{$data->getTeacherInfo->getTeacherUser->last_name}}</td>
	  				<td>
