      ...
      <div class="col-md-3">
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <h3 class="profile-username text-center">{{$main_datas->first_name. " ".$main_datas->middle_name." ".$main_datas->last_name}}</h3>
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <p class="text-muted">
              {{$main_datas->Student_has_parent->father_name}}
            </p>
            <hr> 
            ...
            <p class="text-muted">{{$main_datas->Student_has_parent->address}}</p>
            <hr>
          </div>
        </div>
      </div>
