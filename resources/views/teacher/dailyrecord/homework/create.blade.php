  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6 pl-1">
        <h1 class="text-capitalize">Homework Add</h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
  <div class="card card-info">
    <form role="form" method="POST" action="{{route('teacher.homework.store')}}" class="signup" id="signup">
      <div class="card-body">
        @csrf
        <div class="row">
          ...
          <div class="form-group col-md">
            ...
            <input type="text" class="form-control ndp-nepali-calendar" id="date" name="date" autocomplete="off" value="{{ old('date') }}" placeholder="YYYY-MM-DD">
            @error('date')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
