      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="max" name="max" autocomplete="off" value="{{ old('max') }}">
            @error('max')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="min" name="min" autocomplete="off" value="{{ old('min') }}">
            @error('min')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
