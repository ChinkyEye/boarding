...
<section class="content">
  <div class="card">
    <div class="card-header">
      <form action="{{route('teacher.studenthasmark.ledgermark')}}" method="GET">
        @csrf
        <div class="row">
          <div class="col">
    ...
    <div class="card-body">
     <form role="form" method="POST" action="{{ route('teacher.studenthasmark.storemark')}}">
      @csrf
...
<script>
  ...
  function saveMark() {
    ...
    $.ajax({
        type:"POST",
        dataType:"JSON",
        url:"{{route('teacher.studenthasmark.storemark')}}",
        data:{
          _token: token,
          user_id: user_id,
