      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <img id="blahDoc" src="{{URL::to('/')}}/images/student/document/{{$student->document_photo}}" onclick="document.getElementById('imgInpDoc').click();" alt="your image" class="img-thumbnail" style="width: 175px;height: 140px"/>
          ...
          <div class="form-group col-md-3">
            ...
            <img id="blah" src="{{URL::to('/')}}/images/student/{{$student->image}}" onclick="document.getElementById('imgInp').click();" alt="your image" class="img-thumbnail" style="width: 175px;height: 140px"/>
