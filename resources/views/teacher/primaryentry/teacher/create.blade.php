      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group col-sm-6">
            ...
            <input type="text"  class="form-control max" id="teacher_code" placeholder="Enter teacher_code" name="teacher_code"  autocomplete="off" value="{{ old('teacher_code') }}">
            @error('teacher_code')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-4">
            ...
            <input type="text"  class="form-control max" id="f_name" placeholder="Enter f_name" name="f_name"  autocomplete="off" value="{{ old('f_name') }}">
            @error('f_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-4">
            ...
            <input type="text"  class="form-control max" id="m_name" placeholder="Enter m_name" name="m_name"  autocomplete="off" value="{{ old('m_name') }}">
            @error('m_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-4">
            ...
            <input type="text"  class="form-control max" id="l_name" placeholder="Enter First Name" name="l_name"  autocomplete="off" value="{{ old('l_name') }}">
            @error('l_name')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-4">
            ...
            <small class="text-danger mr-4">*required</small>
            <input type="text"  class="form-control max" id="dob" placeholder="Enter Date of birth" name="dob"  autocomplete="off" value="{{ old('dob') }}" class="nepali-calendar">
            @error('dob')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-2">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="religion" id="hindu" value="hindu" {{ old('religion') == 'hindu' ? 'checked' : ''}}>
          ...
          <div class="form-group col-sm-2">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="nationality_id" id="{{ $nation->id }}" value="{{ $nation->id }}" {{ old('nationality_id') == '$nation->id' ? 'checked' : ''}}>
          ...
          <div class="form-group col-sm-2">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="uppertype" id="temporary" value="temporary" {{ old('uppertype') == 'temporary' ? 'checked' : ''}} >
          ...
          <div class="form-group col-sm-2">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="training" id="certified" value="certified" {{ old('training') == 'certified' ? 'checked' : ''}}>
          ...
          <div class="form-group col-sm-6">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="t_designation" id="primary" value="primary" {{ old('t_designation') == 'primary' ? 'checked' : ''}}>
          ...
          <div class="form-group col-sm-6">
            ...
            <input type="text"  class="form-control max" id="j_date" placeholder="Enter Joining Date" name="j_date"  autocomplete="off" value="{{ old('j_date') }}" class="nepali-calendar">
            @error('j_date')
            <span class="text-danger font-italic" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-sm-6">
            ...
            <input type="text"  class="form-control max" id="p_date" placeholder="Enter broad subject heading" name="p_date"  autocomplete="off" value="{{ old('p_date') }}" class="nepali-calendar">
          </div>
          <div class="form-group col-sm-6">
